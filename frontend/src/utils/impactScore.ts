...
// Prototype Impact Score formula (NOT an official government formula)
// 30% Vegetation Improvement
// 25% Water Improvement
// 15% Land-cover / Environmental Improvement
// 15% Structural Condition
// 10% Hydrological Relevance
// 5% Rainfall-adjusted Response
